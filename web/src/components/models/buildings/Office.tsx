...
export function Office(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/models/buildings/Office.glb') as GLTFResult
  ...
  return (
    <group {...props} dispose={null}>
      <group name="Office002" position={[48.67, -0.166, 77.714]}>
        <mesh name="Plane102" castShadow geometry={nodes.Plane102.geometry} material={materials.WindowNight} >
          {isNight ?
      ...
      <group name="Office003" position={[56.996, -0.166, 75.252]}>
        <mesh name="Plane103" castShadow geometry={nodes.Plane103.geometry} material={materials.WindowNight} >
          {isNight ?
            <meshBasicMaterial color={[1, 1, 1]} toneMapped={false} />
            : null}
        </mesh>
